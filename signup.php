...
<div class="form_container">
	<form method="post" action="index.php" class="box">
		...
		<input type="text" name="txthoten" required placeholder="Full name">
		...
		<input type="password" name="txtxanhanmatkhau" required placeholder="Confirm password">
		<input type="text" name="txtsodienthoai" required placeholder="Phone number">
